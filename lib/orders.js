...
module.exports = function (restClient) {
     ...
     */
    module.incrementIdById = function (orderId) {
        return restClient.get('/orders/' + orderId + '?fields=increment_id');
    };
    ...
    module.cancel = function (orderId) {
        return restClient.post('/orders/' + orderId + '/cancel');
    };
